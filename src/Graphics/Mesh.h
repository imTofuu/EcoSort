...
namespace EcoSort {
    ...
    public:
        ...
        void setPrimaryTexture(const char* path);
        void setPrimaryTexture(const std::shared_ptr<Texture>& texture) { m_primaryTexture = texture; }
    ...
    private:
        ...
        std::shared_ptr<Texture> m_primaryTexture;
